...
const BentoFilters = () => {
  ...
  return (
    <motion.div
      ...
      className="rounded-2xl sm:rounded-3xl bg-secondary p-3 sm:p-6 shadow-bento transition-all duration-300 bento-ease hover:shadow-bento-hover hover:-translate-y-0.5 min-h-[200px] sm:min-h-[260px]"
    >
