      ...
      <div className="mt-4 grid grid-cols-2 gap-4">
        <div className="flex flex-col gap-1">
          <div className="flex items-center gap-2 text-muted-foreground">
            ...
            <span className="text-xs font-body">Temps moyen</span>
          </div>
          <p className="text-2xl font-display font-semibold text-foreground tabular-nums">22 min</p>
        </div>
        <div className="flex flex-col gap-1">
          <div className="flex items-center gap-2 text-muted-foreground">
            <Star className="w-4 h-4" strokeWidth={1.5} />
            <span className="text-xs font-body">Satisfaction</span>
          </div>
