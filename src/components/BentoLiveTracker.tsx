    ...
    >
      ...
      <div className="mt-6">
        <div className="flex items-end justify-between">
          <div>
            <p className="text-sm text-background/60 font-body">Prochaine livraison</p>
            <p className="text-3xl font-display font-semibold text-background tabular-nums mt-1">
              12:04 <span className="text-lg text-background/40">min</span>
            </p>
          </div>
          <div className="flex flex-col items-end gap-1">
            <span className="text-xs text-background/40 font-body">Restaurant → Vous</span>
